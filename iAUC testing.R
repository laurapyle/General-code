...
ogttdat <- read.csv("H:\\Endocrinology\\Chan\\ADA abstract 2019\\CGMInHealthyControls_DATA_2018-12-14_1906.csv")
...
ogttdat <- ogttdat[which(rowSums(!is.na(ogttdat[,cols]))>=4),]
