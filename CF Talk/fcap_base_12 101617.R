...
sas_path <- '"C:/Program Files/SASHome/SASFoundation/9.4/sas.exe"'          # path to SAS (mind the quotes), e.g. '"C:/SASHome/SASFoundation/9.3/sas.exe"'
excel_template <- "H:/Stat references/Group-based trajectory modeling/FCAP model selection plot/fcap_template.xlsx"    # path to F-CAP template, e.g. "C:/myfiles/fcap_template.xlsx"
input_directory <- "H:/BDC/CACTI/CACTI twelve year progression/visit 4 data/"   # path to data directory, e.g. "C:/myfiles/study-A/"
input_file <- "wide_for_traj.sas7bdat"        # sas data file in the data directory, e.g. "opposition.sas7bdat"
output_directory <- "H:/BDC/CACTI/CACTI twelve year progression trajectories/FCAP programs/"  # folder to which results are written, e.g. "C:/myfiles/output/"
...
id <- "StudyID"            # variable name of the identifier, e.g. participant number
var <- "c1-c4"          # dependent outcome variables
indep <- "v1-v4"        # independent variables
model <- "CNORM; MIN 0; MAX 72"        # model: "CNORM", "ZIP", or "LOGIT"
...
poly_order <- 4         # polynomial order: minimum 0, maximum 4

mode <- "ANALYSIS"          # "ANALYSIS": Uses SAS results in the output-directory to create the F-CAP 
