...
sas_path <- '"C:/Program Files/SASHome/SASFoundation/9.3/sas.exe"'          # path to SAS (mind the quotes), e.g. '"C:/SASHome/SASFoundation/9.3/sas.exe"'
excel_template <- "C:/mydocuments/Finite_mixture/proc traj/simulation/Paper_f_cap/final/fcap_template.xlsx"    # path to F-CAP template, e.g. "C:/myfiles/fcap_template.xlsx"
input_directory <- "C:/mydocuments/My SAS Files/traj/"   # path to data directory, e.g. "C:/myfiles/study-A/"
input_file <- "sim_4t_only_error_01_600.sas7bdat"        # sas data file in the data directory, e.g. "opposition.sas7bdat"
output_directory <- "C:/mydocuments/My SAS Files/traj/output/"  # folder to which results are written, e.g. "C:/myfiles/output/"
...
var <- "o1-o6"          # dependent outcome variables
indep <- "t1-t6"        # independent variables
...
poly_order <- 3         # polynomial order: minimum 0, maximum 4
