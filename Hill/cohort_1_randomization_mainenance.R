...
participants <- read.csv('/Volumes/pylell/Hill/Randomization/Maintenance phase randomization/23-2151 Cohort 1 Randomization with Assignments UPDATE.csv')

# 1 participant lost to follow-up - delete
participants <- participants %>% filter(!Assigned.Participant.ID == "BFED211")
...
# output
write.csv(rand, 
          "/Volumes/pylell/Hill/Randomization/Maintenance phase randomization/23-2151 Cohort 1 Randomization with Maintenance Assignments.csv",
          row.names = F)
