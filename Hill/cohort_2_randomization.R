...
participants <- read.csv('/Volumes/pylell/Hill/Randomization/23-2151 Cohort 2 Randomization.csv')
...
# output
write.csv(rand, 
          "/Volumes/pylell/Hill/Randomization/23-2151 Cohort 2 Randomization with Assignments.csv",
          row.names = F)
