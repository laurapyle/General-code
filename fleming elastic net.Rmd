...
source("/Users/laurapyle/Documents/GitHub/shared-resources/Machine Learning/Tim - ElasticNet CV/easy_elasticnet.R")
```

```{r data, include=FALSE}
data <- read.csv("/Volumes/pylell/Fleming dissertation/Data_raw/exportaim1_2matchCATEGORIES.csv", na.strings = c(".",""," "))
...
# Run elastic net and refit the final model
...
kable(tidy(refit_mod),digits = 3, exponentiate=T)
